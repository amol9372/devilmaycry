...
//	
	...
	public ModelAndView viewAutomatedReports2(@RequestParam("domain") String url) throws JsonProcessingException {	
		ModelAndView reportView = new ModelAndView();
		
		List<PowerBiReportModel> reportList = powerbiUtils.getReportsFromFile(url);		
